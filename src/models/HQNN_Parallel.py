...
from src.layers.VQCLayer import VQCLayer

n_qfeatures = 500 # number of input features for the quantum layer
...
class HQNN_Parallel(Module):
	def __init__(self, in_channels, classes):
		...
		self.qlayer1 = VQCLayer(size_in=n_qfeatures, n_qubits=n_qubits, n_qlayers=n_qdepth)
